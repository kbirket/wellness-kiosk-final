        ...
        {activeTab === 'help' && (() => {
          const faqs = [
            ...
            { category: "Member Cards & Print Queue", icon: <QrCode size={20} className="text-[#dba51f]" />, items: [
                ...
                { id: 'card5', q: "Can I see what cards I've already requested?", a: "Currently no — the Card Queue tab is only visible to Kristen (admin). If you need to know whether a card was already requested, ask Kristen. We can add a 'My Requests' view for directors later if it becomes a regular need." },
