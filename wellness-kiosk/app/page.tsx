...
export default function WellnessHub() {
 ...
 const [cardRequestModal, setCardRequestModal] = useState(null);
  ...
  const [cardQueue, setCardQueue] = useState([]);   const [editPaymentModal, setEditPaymentModal] = useState(null);
                      ...
                      return (
                        <tr key={p.airtableId} className="border-b hover:bg-slate-50/80">
                          ...
                          <td className="px-4 py-4">
                           {user && user.role !== 'business' && p.memberId !== 'VISITOR' && (<div className="flex gap-1 justify-end"><button onClick={function() { setEditPaymentModal(p); }} className="text-slate-300 hover:text-[#1080ad] transition-colors p-1" title="Edit this payment"><FileText size={14}/></button>
