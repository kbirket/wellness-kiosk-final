        ...
        {activeTab === 'help' && (() => {
          const faqs = [
            { category: "Membership Management", icon: <Users size={20} className="text-[#1080ad]" />, items: [
                ...
                { id: 'm22', q: "How do I see who has paid and who hasn't?", a: "Two quick ways:<br/><br/>1. <b>Payment column</b> — scan down the checkmarks and X's on the Members tab. Green check = paid, red X = not paid.<br/>2. <b>Filter buttons</b> — tap 'Paid' to see only members who have paid this month, or tap 'Unpaid' to see everyone who still owes." }
            ]},
