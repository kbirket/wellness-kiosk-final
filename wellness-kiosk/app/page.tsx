...
>
  💳 Print Active Member VIP Cards
            ...
            <button onClick={() => {
              ...
              const backTag = '<div class="kt-back"><img src="/wellness_corner_2.png" /><div class="biz">Patterson Health Center Wellness Centers</div><div class="ret">If found, please return.<br/>Harper 620-896-1202 &bull; Anthony 620-842-5190</div></div>';
              let pages = '';
              for (let i = 0; i < count; i++) { pages += '<div class="card">' + backTag + backTag + backTag + '</div>'; }
              const html = '<!DOCTYPE html><html><head><title>Keytag Backs (' + count + ')</title><link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700;900&display=swap" rel="stylesheet"><style>@page{size:2.125in 3.375in;margin:0}@media print{*{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}.card{page-break-after:always}}body{font-family:Montserrat,Arial,sans-serif;margin:0;padding:0;background:#fff}.card{width:2.125in;height:3.375in;display:flex;flex-direction:column;box-sizing:border-box}.kt-back{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;box-sizing:border-box;padding:0.08in;overflow:hidden;transform:rotate(180deg)}.kt-back img{height:0.6in;max-width:88%;object-fit:contain;margin-bottom:0.05in}.biz{font-size:7px;font-weight:900;color:#003d6b;letter-spacing:0.3px;text-align:center;line-height:1.2}.ret{font-size:6px;font-weight:700;color:#64748b;letter-spacing:0.2px;text-align:center;line-height:1.3;margin-top:0.03in}</style></head><body>' + pages + '</body></html>';
              const w = window.open('', '_blank');
              w.document.write(html);
              w.document.close();
