...
const processCheckIn = async (memberId, method = "Manual Entry") => {
    ...
    if (m) {
      ...
      if (recentDupe) {
        setKioskMessage({ text: 'Already checked in!', type: 'warning', subtext: m.firstName + ' was checked in within the last 2 hours.' });
