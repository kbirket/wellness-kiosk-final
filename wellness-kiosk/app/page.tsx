        ...
        {activeTab === 'help' && (() => {
          const faqs = [
            { category: "Membership Management", icon: <Users size={20} className="text-[#1080ad]" />, items: [
                ...
                { id: 'm3', q: "How do I log a member's payment?", a: "Open the member's profile. Click the green 'Log Payment' button at the bottom. If this is a new member's first month, check the <b>'Prorate First Month'</b> box — the system will automatically calculate the amount based on how many days are left in the month. Then select the payment method (Cash, Check, Card, or ACH). After the payment is logged, you will be asked if you want to print a receipt for the member." },
                ...
                { id: 'm15', q: "How do I print a receipt for a member?", a: "<b>After logging a payment:</b> The system will ask 'Print a receipt?' — click OK and a branded receipt opens in a new tab ready to print.<br/><br/><b>Anytime from their profile:</b> Open the member's profile and click the green 'Print Receipt' button. This prints a receipt based on their current monthly rate and last payment method on file." },
