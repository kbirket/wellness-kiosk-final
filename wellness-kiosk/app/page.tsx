  ...
  const processCheckIn = async (memberId, method = "Manual Entry") => {
    ...
    if (m) {
      ...
      if (needsAnthony || needsHarper) {
        ...
        setKioskMessage({ text: 'Orientation Required', type: 'error', subtext: `Please see front desk to complete your ${centerName} orientation.` });
      ...
      const scanCenter = currentLoc.charAt(0).toUpperCase() + currentLoc.slice(1);
