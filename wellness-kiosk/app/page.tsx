      ...
      <main className="flex-1 p-10 h-screen overflow-y-auto relative print:m-0 print:p-0 print:h-auto print:overflow-visible">
        ...
        {activeTab === 'help' && (() => {
          const faqs = [
            ...
            { category: "Public Kiosk (iPad)", icon: <Smartphone size={20} className="text-[#1080ad]" />, items: [
            ...
            { category: "System & Administration", icon: <ShieldCheck size={20} className="text-[#f59e0b]" />, items: [
                { id: 's1', q: "Who are the directors?", a: "<b>Patrick Johnson</b> — Harper Wellness Center<br/><b>Deanna Smithhisler</b> — Anthony Wellness Center<br/><br/>Directors log in through the 'Director Portal' button on the landing page." },
                ...
                { id: 's6', q: "Where is the data stored?", a: "All member, visitor, corporate partner, and visit data is stored in Airtable. The Wellness Hub reads and writes to Airtable through API routes hosted on Vercel. The Drupal website (pattersonhc.org) is separate." }
            ]}
          ];
          return (
