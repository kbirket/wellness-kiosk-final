      ...
      {paymentModal && (() => {
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
         ...
         <div className="mb-5">
          ...
          <button onClick={() => { setPaymentModal(null); setCheckNumber(''); setCustomPayAmount(''); }} className="w-full text-slate-400 text-sm font-bold hover:text-slate-600">Cancel</button>
          </div>
        </div>
        );
      })()}
