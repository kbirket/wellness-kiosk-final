    ...
    const getAutoClass = () => {
      ...
      schedule.forEach(c => {
        if ((c.center === viewingCenter || viewingCenter === 'both') && c.days.includes(todayName)) {
          ...
          // Auto-assigns if they check in up to 60 mins early, or 30 mins late!
...
<div>
  ...
  />
                     ...
                     {!familyFlow && (
                       <>
                         <div className="grid grid-cols-2 gap-5">
                            <div><label className="text-xs font-bold text-slate-400 uppercase mb-1 ml-2 block tracking-widest">Plan Type</label><select id="plan" onChange={e => { const v = e.target.value; if (!v.includes('CORPORATE') && !v.includes('HD6') && !v.includes('HCHF')) { setSelectedSponsor(''); setCustomSponsor(''); } }} className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-[#1080ad] transition-colors font-bold text-slate-700"><option value="FIRST DAY FREE">First Day Free</option><option value="SINGLE">Single</option><option value="FAMILY">Family</option><option value="SENIOR CITIZEN">Senior Citizen</option><option value="SENIOR FAMILY">Senior Family</option><option value="STUDENT">Student (14-22)</option><option value="CORPORATE">Corporate</option><option value="CORPORATE FAMILY">Corporate Family</option><option value="MILITARY">Military</option><option value="HD6">Staff (HD6)</option><option value="HCHF">Staff (HCHF)</option></select>
                 ...
                 <div className="space-y-4 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div><label className="text-xs font-bold text-slate-400 uppercase mb-1 block">Plan Type</label>
                        <select id="ed_plan" defaultValue={selectedMember.type} className="w-full p-3 bg-slate-50 border rounded-xl text-sm outline-none focus:border-[#1080ad] font-bold"><option value="FIRST DAY FREE">First Day Free</option><option value="SINGLE">Single</option><option value="FAMILY">Family</option><option value="SENIOR CITIZEN">Senior Citizen</option><option value="SENIOR FAMILY">Senior Family</option><option value="STUDENT">Student (14-22)</option><option value="CORPORATE">Corporate</option><option value="CORPORATE FAMILY">Corporate Family</option><option value="MILITARY">Military</option><option value="HD6">Staff (HD6)</option><option value="HCHF">Staff (HCHF)</option></select>
                      </div>
