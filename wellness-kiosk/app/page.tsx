...
if (memberBatch.length < 3 && !window.confirm('You selected ' + memberBatch.length + '. The other ' + (3 - memberBatch.length) + ' slot(s) will print blank, and that part of the card is wasted.\n\nPrint anyway?')) return;
                    ...
                    const renderKeytag = (data) => {
                      ...
                      return '<div class="keytag"><div class="accent-bar" style="background:' + accentColor + '"></div><div class="info"><div class="id">' + m.id + '</div><div class="center" style="color:' + accentColor + '">' + centerLabel + ' Wellness Center</div></div><img class="qr" src="' + qrUrl + '" /></div>';
                    };
