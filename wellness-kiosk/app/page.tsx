           ...
           <div className="bg-white rounded-[2rem] w-full max-w-4xl flex overflow-hidden shadow-2xl relative">
              ...
              <div className="flex-1 p-16 overflow-y-auto">
                 ...
                 <div className="mt-14 flex gap-4">
                    ...
                    {user?.role === 'admin' && (<button onClick={handleDeleteMember} disabled={isDeleting} className="px-6 bg-red-50 text-red-600 hover:bg-red-600 hover:text-white py-4 rounded-xl font-bold shadow-sm transition-all flex items-center justify-center">{isDeleting ? '...' : <Trash2 size={20}/>}</button>)}
                 </div>
              </div>
           </div>
        </div>
