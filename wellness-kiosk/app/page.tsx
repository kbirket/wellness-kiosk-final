                ...
                <div className="flex gap-3 flex-wrap">
                  ...
                  <button onClick={() => {
                    ...
                    const getPaymentForMember = (m) => {
                      ...
                      const periodPay = payList.find(p => { if (!p.date) return false; const d = new Date(p.date); return d.getFullYear() === parseInt(reportMonth.split('-')[1]) && d.getMonth() === parseInt(reportMonth.split('-')[0]) - 1; });
