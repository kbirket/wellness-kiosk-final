...
const handleAddMemberSubmit = async (e) => {
    ...
    const basicOrient = e.target.basicOrient?.checked || false;
                    ...
                    <div key={req.airtableId + '-' + context} className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1 flex-wrap">
                          ...
                          <span className={"px-2 py-0.5 rounded-full text-[9px] font-black uppercase " + typeColor}>{req.printType || 'Card'}</span>
                        </div>
        ...
        setMembers(filteredOut); } setLoading(false); }); }} className={`${familyFlow ? 'flex-1' : 'w-full'} bg-[#001f3f] text-white px-8 py-4 rounded-xl font-bold`}>Done</button>
                ...
                <>
                  ...
                  <form onSubmit={handleAddMemberSubmit} className="space-y-5">
                     ...
                     <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 space-y-3"><p className="text-[10px] font-black text-emerald-600 uppercase tracking-widest">Onboarding (check if already done at sign-up)</p><label className="flex items-center gap-3 cursor-pointer hover:bg-emerald-100 rounded-lg p-2 -m-1 transition-colors"><input type="checkbox" id="basicOrient" className="w-5 h-5 rounded border-slate-300 text-emerald-600 accent-emerald-600" /><div><p className="text-sm font-bold text-emerald-800">Basic Orientation Complete</p></div></label><label className="flex items-center gap-3 cursor-pointer hover:bg-emerald-100 rounded-lg p-2 -m-1 transition-colors"><input type="checkbox" id="paperwork" className="w-5 h-5 rounded border-slate-300 text-emerald-600 accent-emerald-600" /><div><p className="text-sm font-bold text-emerald-800">Paperwork Completed</p></div></label></div>
